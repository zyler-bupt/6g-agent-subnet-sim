...
def _paper_trial_from_formation(
    ...
    *,
    ...
    return PaperTrial(
        ...
        t_ctrl_ms=outcome.t_ctrl_ms,
        t_dispatch_ms=outcome.t_dispatch_ms,
        t_install_ms=outcome.t_install_ms,
        t_verify_ms=outcome.t_verify_ms,
        t_activate_ms=outcome.t_activate_ms,
        deploy_mode=outcome.deploy_mode,
